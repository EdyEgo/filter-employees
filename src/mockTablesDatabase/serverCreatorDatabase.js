...
function createDummyDepartamente() {
  ...
  for (let i = 0; i < 50000; i++) {
    ...
    createdObject.push({
      ...
      role: functiiAngajati[getRandomArbitrary(0, 3)],
      salary: getRandomArbitrary(3000, 32000),
      offDays: getRandomArbitrary(2, 25),
    });
  }
...
let departamentsDataToWrite = [
  ...
  },
  {
    ...
    descriere:
      "descriere alt departament: acest departament are alta descriere",
  },
  {
    id: 9,
    nume: "ultimul departament",
    descriere:
      "ultimul departament descriere: din pacate acesta este ultimul departament",
  },
];
